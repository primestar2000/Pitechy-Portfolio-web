    ...
    return(
        ...
        <nav className={`${navigationExpanded && 'bg-slate-50 dark:bg-slate-800'} w-full  justify-between flex flex-col md:flex-row p-5  items-center`} >
            ...
            <ul className={`${!navigationExpanded && 'hidden'} md:flex flex-col text-center items-center md:flex-row  w-[50%] justify-evenly`}>
                ...
                <li><a  href="#work" onClick={()=>setNavigationExpanded(false)} className="hover:bg-violet-500 p-3 font-semibold text-lg text-slate-500 dark:text-white">Portfolio</a></li>
                <li><a  href="#skills" onClick={()=>setNavigationExpanded(false)} className="hover:bg-violet-500 p-3 font-semibold text-lg text-slate-500 dark:text-white">Skills</a></li>
                <li><a  href="#testimonial" onClick={()=>setNavigationExpanded(false)} className="hover:bg-violet-500 p-3 font-semibold text-lg text-slate-500 dark:text-white">Testimonial</a></li>
                <li><a href="#contact" onClick={()=>setNavigationExpanded(false)} className="hover:bg-violet-500 p-3 font-semibold text-lg text-slate-500 dark:text-white">Contact</a></li>
            </ul>
