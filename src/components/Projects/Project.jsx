...
const Project = ({data}) => (
    ...
    <>
        <div className="max-w-full shadow-xl rounded-lg lg:rounded-3xl  lg:max-h-[450px] dark:bg-slate-800 m-4 items-center flex-col-reverse lg:p-10 flex lg:flex-row">
