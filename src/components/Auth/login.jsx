            ...
            <div className="h-screen w-[full]  flex justify-center items-center">
                <div className="w-full h-full lg:h-fit max-w-[800px] flex justify-center gap-4 bg-slate-200 lg:rounded-3xl p-10 shadow-md">
                    ...
                    <div className="w-full lg:w-1/2 lg:p-8 flex flex-col gap-5">
                        ...
                        <div className="w-full h-10 bg-orange-2 text-white border-[2px] border-solid p-2 px-4 rounded-3xl flex gap-4 items-center justify-center">
                            <p>Google</p>
                            <FontAwesomeIcon icon={faGoogle} className="text-red-800"/>
                        </div>
                    </div>
                </div>
            </div>
